#ifndef __EW_EWA_BASE_UTIL_DCONTEXT_H__
#define __EW_EWA_BASE_UTIL_DCONTEXT_H__

#include "ewa_base.h"
#include "ewa_base/math/tiny_mat.h"
#include "ewa_base/util/symm.h"
#include "ewa_base/util/dunit.h"
...
public:
	...
	void init(CallableSymbol* p,CallableSymbol* b=NULL);

	void pop();

	void push(CallableSymbol* p);

	int ref;
	int val;

	arr_1t<CallableSymbol*> stk;
	indexer_set<DataPtrT<CallableSymbol> > arr;
};
...
public:
	...
	virtual void RenderObject(CallableSymbol* p);
